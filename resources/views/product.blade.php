...
<div class="product-grid">
    ...
    <div class="product-card" data-category="basketball">
        ...
        <p class="product-description">The new Air Bretts with comfort and style like no other!</p>
...
<!-- 'data-product-id' uniquely identifies the product for backend integration -->
    ...
    <div class="product-card" data-category="training">
        <div class="product-image-container">
            <img src="path-to-image3.jpg" alt="Shadow Runners" class="product-image">
        </div>
        <h2 class="product-title">Shadow Runners</h2>
...
<!-- 'data-product-id' uniquely identifies the product for backend integration -->
    ...
    <div class="product-card" data-category="soccer">
        <div class="product-image-container">
            <img src="path-to-image4.jpg" alt="Goal Masters" class="product-image">
        </div>
        <h2 class="product-title">Goal Masters</h2>
